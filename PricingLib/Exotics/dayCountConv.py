...
def act_act_icma(
    ...
    """Calculate the day count fraction and factor for the ACT_ACT_ICMA convention.

    Args:
        start_date (str): The start date in YYYYMMDD format.
        end_date (str): The end date in YYYYMMDD format.
        settlement_date (str): The settlement date in YYYYMMDD format.
        frequency (FrequencyType): The frequency type.

    Raises:
        ValueError: If frequency or settlement date is not provided.

    Returns:
        tuple | Tnumber: The day count fraction, numerator, and denominator.
    """
    datetime_object_start: datetime = datetime.strptime(start_date, "%Y%m%d")
...
def thirty_e_360_isda(start_date: str, end_date: str) -> tuple | Tnumber:
    """Calculate the day count fraction and factor for the THIRTY_E_360_ISDA convention.
